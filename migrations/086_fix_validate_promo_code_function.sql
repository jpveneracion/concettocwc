-- Migration 086: Fix validate_promo_code_for_payment function - proper jsonb plan matching
...
BEGIN
  -- Resolve plan identifier from tier name
  ...
  -- Check if code applies to requested plan - use jsonb ?| operator for array contains

// Run with: node scripts/run-subscription-migration.js
...
async function migrate() {
  ...
  try {
    ...
    const migration = fs.readFileSync('migrations/subscription-system.sql', 'utf8');
    ...
    console.log('✅ Subscription system migration complete.');
    process.exit(0);
  } catch (err) {

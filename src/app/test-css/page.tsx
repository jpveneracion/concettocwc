      ...
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-xl p-8">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-indigo-100 border-l-4 border-indigo-500 p-4 rounded">
            <p className="text-indigo-700 font-semibold">Blue test box visible</p>
          </div>
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-indigo-100 p-4 rounded">
            <p className="text-indigo-700">Responsive Grid Test (1 col on mobile, 2 on desktop)</p>
          </div>
          <div className="bg-indigo-100 p-4 rounded">
            <p className="text-indigo-700">If you see this side-by-side on desktop, responsive CSS works!</p>
          </div>
        </div>

    ...
    <div className="p-6 space-y-6">
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
          ...
          <button
            ...
            className="px-4 py-2 bg-stone-600 text-white rounded-lg hover:bg-stone-700 transition-colors text-sm"
          >
            Settings Guide
          </button>
        </div>
      ...
      <div className="bg-stone-50 rounded-lg p-6 border border-stone-200">
        ...
        <div className="space-y-4 text-sm">
          <div>
            <h4 className="font-medium text-stone-900">General Onboarding:</h4>
...
/>`}
          ...
          <div>
            <h4 className="font-medium text-stone-900">Feature Onboarding:</h4>
            <pre className="mt-2 p-3 bg-white rounded border overflow-x-auto">
